...
The ID of the source tile in the [Tileset](../properties/Tileset) that represents the [TextureRegion](../../../TextureRegion/) to  render for the [Tile](../../Tile/) element being set.
